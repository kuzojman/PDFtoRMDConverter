...
conda activate pdftormd
```
Для преобразования файла pdf, png или jpg файла в rmd:
```text
python PDF2RMDConverter.py pdf2rmdconverter.convert "<путь к файлу 1>" "<путь к файлу 2>" ... "<путь к файлу n>" 
```  
...
```text
python PDF2RMDConverter.py pdf2rmdconverter.convert "C:\example\article.pdf"
```
